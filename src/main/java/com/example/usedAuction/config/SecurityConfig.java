    ...
    SecurityFilterChain filterChain(HttpSecurity http)throws  Exception{
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .antMatchers(HttpMethod.POST, "/api/sign-up/phone-check").permitAll()
                        ...
                        .antMatchers(HttpMethod.POST, "/api/mail-auth").permitAll()
                        .antMatchers(HttpMethod.POST, "/api/mail-auth-number").permitAll()
                        ...
                        .antMatchers(HttpMethod.POST, "/api/find-password").permitAll()
